...
DEFAULTS: dict[str, Any] = {
    ...
    "take_profit_pct": float(os.getenv("STRATEGY_TAKE_PROFIT_PCT", "1.5")),
    "stop_loss_pct": float(os.getenv("STRATEGY_STOP_LOSS_PCT", "0.8")),
    ...
    "force_trade_sec": int(os.getenv("STRATEGY_FORCE_TRADE_SEC", "600")),
